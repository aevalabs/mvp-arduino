...
void readTemp(void) 
{
  ...
  float temp4=0;
  float temp5=0;
  temp1=Thermistor(analogRead(TEMP_PIN));       // read ADC and  convert it to Celsius
  temp2=Thermistor(analogRead(TEMP_PIN));       // read ADC and  convert it to Celsius
  temp3=Thermistor(analogRead(TEMP_PIN));       // read ADC and  convert it to Celsius
  temp4=Thermistor(analogRead(TEMP_PIN));       // read ADC and  convert it to Celsius
