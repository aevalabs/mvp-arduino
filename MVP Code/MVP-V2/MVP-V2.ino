...
/////////////////////////////// END BUTTONS //////////////////////////
             ...
             ////// start of paste
              else if(touchLocations[i].x>=265&&touchLocations[i].x<=305&&touchLocations[i].y>=303&&touchLocations[i].y<=333 )
              {
               ...
               minutes1=minutes1+1;
                ...
                myGLCD.setColor(255,255,255);
                myGLCD.setFont(SevenSegNumFont);
                myGLCD.print(newmins1, 440, 420);
                
                //Serial.println(newmins2);
                myGLCD.setColor(VGA_GRAY);
                myGLCD.setColor(255,255,255);
                myGLCD.setFont(SevenSegNumFont);
                myGLCD.print(newmins2, 410, 420);
                myGLCD.setColor(255,255,255);
                myGLCD.fillCircle (390,315, 4);
                myGLCD.setColor(255,255,255);
                myGLCD.fillCircle (390,325, 4);
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    minutes1=minutes1-1;
      ...
      myGLCD.setBackColor(VGA_GRAY);
      myGLCD.setFont(BigFont);
      myGLCD.print("P1 complete", 40, 360);
      delay(5000);
       myGLCD.print("START P2   ", 40, 360); 
       Start_flag = 0;
    }
    }
}
...
if (Start_flag == 2){
  if (currentMillis - previousMillis2 >= interval) {
    ...
    minutes1=minutes1-1;
      ...
      delay(5000);
       myGLCD.print("Starting Process 3", 60, 360); 
       Start_flag = 0;
    }
}
  ...
  if (Start_flag == 1){
    ...
    if(TotalTime > 1){
      ...
      if(currentTemp >75){
        ...
        digitalWrite(COOLING_PIN, LOW);    //Turn on cooling  
        //PAUSE TIMER
        myGLCD.print("WARNING: TEMP ERROR", 30, 400);
      }
