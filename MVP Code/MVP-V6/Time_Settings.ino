...
myGLCD.fillCircle (400,360, 4);
  ...
  if(default_hours<10)
  {                                              
    myGLCD.print(default_newhours, 355, 325);
  ...
  {                                              
    myGLCD.print(default_newhours, 325, 325);
  } 
P1_Hours = atoi(default_newhours);
P1_Minutes1 = atoi(default_newmins2);
P1_Minutes2 = atoi(default_newmins1);
